sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("namnd/com/vn/ZAPP_NAMND_DEMO/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Demoapp-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Demoapp-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("namnd.com.vn.ZAPP_NAMND_DEMO.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["namnd/com/vn/ZAPP_NAMND_DEMO/localService/mockserver"], function (mockserver) {
